...
public class OoBMecanumDT extends OoBHardwareBot{
    // CONSTANTS
     ...
     */
    protected OoBHardwareStatus initDriveTrainMotors()
    {
    ...
    protected double getTargetEncCount(double targetDistanceInches)
    {
        ...
        degreesOfWheelTurn = (360.0 / (Math.PI * OoBMecanumDT.WHEEL_DIAMETER_INCHES)) *
                targetDistanceInches;
        degreesOfMotorTurn = OoBMecanumDT.DRIVE_GEAR_REDUCTION * degreesOfWheelTurn;
        return (OoBMecanumDT.COUNTS_PER_MOTOR_REV * degreesOfMotorTurn) / 360.0;
    }
